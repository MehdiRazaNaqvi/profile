            ...
            >
              {!isBlog ? (
                <div className="grid grid-cols-1">
                  ...
                  <Button onClick={handleReviewsScroll}>Testimonials</Button>
                  ...
                  {showResume && (
                    <Button
                      onClick={() =>
                        window.open("mailto:mehdiraza1232016@gmail.com")
                      }
                    >
                      Resume
                    </Button>
                  ...
                  <Button
                    onClick={() => window.open("mailto:mehdiraza1232016@gmail.com")}
                  >
                    Contact
                  </Button>
                </div>
      ...
      >
        ...
        {!isBlog ? (
          <div className="flex">
            ...
            <Button onClick={() => window.open("mailto:mehdiraza1232016@gmail.com")}>
              Contact
            </Button>
